...
class BugGreenCommit(Commit):
    """Commit class for bug green step.
    ...
    def create(
        ...
        *,
        ...
        """Create a git commit for the bug green step.

        Args:
            result: The BugGreenResult from command execution
        ...
        message = f"🦋 Fix bug verified by {test_specifier}"
