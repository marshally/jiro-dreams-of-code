"""Verification for bug green step.

Verifies that the bug green step result meets the verification rules:
...
class BugGreenVerify(Verification):
    """Verification for bug green step.
    ...
    def verify(self, *, result: Result) -> VerificationResult:
        """Verify the bug green step result.
