...
class BugRedCommit(Commit):
    """Commit class for bug red step.
    ...
    def create(
        ...
        *,
        ...
        """Create a git commit for the bug red step.
        ...
        message = f"🐛 Add failing test to reproduce {test_name}"
