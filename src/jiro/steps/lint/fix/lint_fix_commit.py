...
class LintFixCommit(Commit):
    """Commit class for lint fix step.

    Handles:
    - Staging the fixed file
    - Creating a git commit with 🧹 emoji
    - Commit message format: "🧹 lint fix {error_code} in {filename}"
    """
    ...
    def create(
        ...
        *,
        ...
        """Create a git commit for the lint fix step.
        ...
        message = f"🧹 lint fix {error_code} in {filename}"
