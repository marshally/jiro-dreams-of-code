...
class TddRedCommit(Commit):
    """Commit class for TDD red step.

    Handles:
    - Staging the test file
    ...
    def create(
        ...
        *,
        ...
        """Create a git commit for the TDD red step.
        ...
        message = f"🔴 Add failing test for {test_name}"
