"""Verification for TDD refactor step.

Verifies that the TDD refactor step result meets the verification rules:
...
class TddRefactorVerify(Verification):
    """Verification for TDD refactor step.
    ...
    def verify(self, *, result: Result) -> VerificationResult:
        """Verify the TDD refactor step result.
