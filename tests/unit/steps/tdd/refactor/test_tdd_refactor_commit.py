"""Tests for TddRefactorCommit class."""
...
class TestTddRefactorCommitIsCommit:
    """Test that TddRefactorCommit is a proper Commit subclass."""

    def test_is_commit_subclass(self):
        """TddRefactorCommit should inherit from Commit."""
        assert issubclass(TddRefactorCommit, Commit)

    def test_can_instantiate(self):
        """Should be able to instantiate TddRefactorCommit."""
        commit = TddRefactorCommit()
        assert isinstance(commit, TddRefactorCommit)


class TestTddRefactorCommitStageFiles:
...
class TestTddRefactorCommitExtractSha:
    ...
    def test_extracts_sha_from_standard_output(self):
        ...
        sha = TddRefactorCommit._extract_sha(output)
        assert sha == "abc1234"
    ...
    def test_raises_on_invalid_output(self):
        ...
        with pytest.raises(ValueError, match="Could not extract SHA"):
            TddRefactorCommit._extract_sha(output)


class TestTddRefactorCommitCreate:
